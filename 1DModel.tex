...
\section{\label{sec:Turning} Turning Time}

\section{\label{sec:TInt} Integral for Turning Time}
...
\subsection{\label{sec:calct} Calculating Turning Time}
...
\section{\label{sec:calcE0} Integral for Binding Time}
...
\begin{equation*}
\Delta t_B = t_T - t_B \quad ; \quad
t_T - \Delta t_B < (t = 20 ~ \text{ns}) < t_T + \Delta t_B
\end{equation*}
